                                    ...
                                    protected Boolean doInBackground(Void... params) {
                                        ...
                                        try {
                                            ...
                                            for (ElaborationResult result : selectedItems) {
                                                ...
                                                if (result.getResultTableName() != null && !SpatialiteUtils.deleteResult(db, result.getResultTableName())) {
                                                    Log.w(TAG, "error deleting result " + result.getResultTableName());
                                                    return false;
                                                }


                                                if (result.getResultTableName() != null && !SpatialiteUtils.deleteResultFromNamesTable(db, result.getResultTableName())) {
                                                    Log.w(TAG, "error deleting result from names table " + result.getResultTableName());
                                                    return false;
                                                }
                                            }
                                            return true;
